...
import edu.br.ifnmg.trabalho2.kesia.entidade.validarNomeUsuario;
import edu.br.ifnmg.trabalho2.kesia.excecao.CampoObrigatorioException;
import edu.br.ifnmg.trabalho2.kesia.excecao.CampoPesquisaObrigatorioException;
...
public class CadastroUsuarioForm extends javax.swing.JFrame {
     ...
     private ConsultaUsuariosForm consultaUsuarioForm;
    ...
    public CadastroUsuarioForm(ConsultaUsuariosForm consultaUsuarioForm, Usuario usuarioEdicao) {
    ...
    private void initComponents() {
        ...
        btnSalvar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/br/ifnmg/trabalho2/kesia/apresentacao/icones/salvar.png"))); // NOI18N
        ...
        btnNovo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/br/ifnmg/trabalho2/kesia/apresentacao/icones/add.png"))); // NOI18N
        ...
        btnPesquisar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/edu/br/ifnmg/trabalho2/kesia/apresentacao/icones/buscar.png"))); // NOI18N
    ...
    private void fecharCadastroUsuario(){
        ...
        if (consultaUsuarioForm == null) {
           consultaUsuarioForm = new ConsultaUsuariosForm();
        }
    ...
    private void salvarUsuario(){
     ...
     private void pesquisarUsuario() {
        try {
            ...
            UsuarioBO usuarioBO = new UsuarioBO();
            usuario = usuarioBO.pesquisar(usuarioBuscado);
