 ...
 */
public class ListagemUsuariosForm extends javax.swing.JFrame {
    ...
    private void editarUsuario(){
        ...
        if (linhaSelecionada != -1) {
            ...
            ListagemUsuariosForm.this.dispose();
        } else {
    ...
    private void initComponents() {
        ...
        btnEditar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/trabalho2/kesia/apresentacao/icones/editar.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListagemUsuariosForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListagemUsuariosForm().setVisible(true);
            }
        });
    }
